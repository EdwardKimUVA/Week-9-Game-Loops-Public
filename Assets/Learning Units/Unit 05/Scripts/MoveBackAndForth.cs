...
public class MoveBackAndForth : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        foreach(GameObject thisthingy in ObjectsToMove)
        {
            startPositions.Add(thisthingy.transform.position); // one of these lists needs this kind of position...
            endPositions.Add(thisthingy.transform.position + new Vector3(0,0,10f)); // another one needs another...
        }
    }
